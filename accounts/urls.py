...
urlpatterns = [
    ...
    path('teacher/courses/<uuid:course_uid>/resources/add/', views.add_resource, name='add_resource'),
    path('teacher/resources/<uuid:resource_uid>/delete/', views.delete_resource, name='delete_resource'),
