...
<div class="row"><span class="label">Cloud Drive Backup</span><span class="value {'good' if drive_ok else 'bad'}">{'✅ Connected' if drive_ok else '❌ Not configured'}</span></div>
</div>
